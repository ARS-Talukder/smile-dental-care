...
const Login = () => {
    ...
    if (error1) {
        ...
        return (
            <div>
                <h2>This email has no account</h2>
                <h2 className='text-danger fw-bold'>Please Reload Page</h2>
            </div>
        );
    }
    if (user) {
    ...
    return (
        <div>
            ...
            <Form onSubmit={handleSignIn} className='w-50 mx-auto mt-4'>
                ...
                <p className='text-start'>New at smile dental care? <span><Link to='/register'>create account</Link></span> </p>
